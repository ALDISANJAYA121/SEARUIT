...
<body>
        ...
        <div class="lg:col-span-3">
            <div class="fixed w-full top-0 z-50 bg-[#faf9f9]">
                <div class="lg:hidden block mt-5 rounded-lg py-1 bg-[#1EA05E] text-white mx-4">
                    ...
                    <p class="-mt-5 md:text-lg text-sm lg:text-start text-center">Satu Ruang Informasi untuk Inovasi Terintegrasi</p>
                </div>
    ...
    <div class="lg:col-span-9 lg:pr-3 lg:pl-5 lg:py-1 md:p-12 px-4 mt-1 pb-4 overflow-auto custom-scrollbar">
        ...
        <div class="my-3">
            ...
            <div id="bps_lampung" class="grid lg:grid-cols-5 md:grid-cols-4 sm:grid-cols-3 grid-cols-2 gap-2 custom-scrollbar transition-max-height duration-500 ease-in-out">
                @foreach ($lists_bps_lampung as $item)
                <div class="rounded-lg border border-neutral-200 p-2 hit-button" data-id={{ $item->id }}>
                    <a href="{{ $item->link }}" target="_blank">
                        <div class="flex flex-row justify-between items-center">
